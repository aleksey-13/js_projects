export default class View {
  ...
  renderPanel({ level, score, lines, nextPiece }) {
    ...
    for (let r = 0; r < nextPiece.blocks.length; r++) {
      for (let c = 0; c < nextPiece.blocks[r].length; c++) {
        const block = nextPiece.blocks[r][c];

        if (block) {
          this.renderBlock(
            this.panelX + r * this.blockWidth * 0.5,
            this.panelY + 120 + c * this.blockHeight * 0.5,
            this.blockWidth * 0.5,
