      ...
      if ((null != f.deprecationHandler && f.deprecationHandler(null, i), a)) {
        ...
        for (t = 0; t < arguments.length; t++) {
          if (((e = ""), "object" == typeof arguments[t])) {
            for (n in ((e += "\n[" + t + "] "), arguments[0]))
              m(arguments[0], n) && (e += n + ": " + arguments[0][n] + ", ");
            e = e.slice(0, -2);
          } else e = arguments[t];
          s.push(e);
        }
        ...
        (R[t] =
          ...
          (function (s) {
            ...
            return function (e) {
              var t,
                n = "";
              for (t = 0; t < i; t++) n += O(r[t]) ? r[t].call(e, s) : r[t];
              return n;
            };
          })(t)),
        R[t](e))
    ...
    return (function (e) {
      for (var t, n, s, i, r = 0; r < e.length; ) {
        for (
          ...
          if (n && n.length >= t && at(i, n) >= t - 1) break;
          t--;
        }
        r++;
      }
    ...
    if (e._f !== f.ISO_8601)
      if (e._f !== f.RFC_2822) {
        ...
        var t,
          ...
          d = h.length,
          c = 0;
        for (s = H(e._f, e._locale).match(N) || [], t = 0; t < s.length; t++)
          (i = s[t]),
            (n = (h.match(fe(i, e)) || [])[0]) &&
            ...
            W[i]
              ? (n ? (y(e).empty = !1) : y(e).unusedTokens.push(i),
                (o = i),
                (l = e),
                null != (u = n) && m(_e, o) && _e[o](u, l._a, l, o))
      ...
      1 === arguments.length &&
        (Kt(arguments[0])
          ...
          : (function (e) {
              ...
              for (t = 0; t < i.length; t += 1) s = s || m(e, i[t]);
              return n && s;
  ...
  (kn.calendar = function (e, t, n) {
    ...
    (kn.eras = function (e, t) {
      var n,
        s,
        i,
        r = this._eras || dt("en")._eras;
      for (n = 0, s = r.length; n < s; ++n) {
        switch (typeof r[n].since) {
          case "string":
            (i = f(r[n].since).startOf("day")), (r[n].since = i.valueOf());
            break;
        }
        switch (typeof r[n].until) {
          case "undefined":
            ...
            break;
          case "string":
            (i = f(r[n].until).startOf("day").valueOf()),
              (r[n].until = i.valueOf());
            break;
        }
      }
